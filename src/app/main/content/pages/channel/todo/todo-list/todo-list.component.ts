            ...
            this.todoService.onCurrentTodoChanged
                .subscribe(currentTodo => {
                    if ( !currentTodo )
                    {
                        ...
                        if ( tagHandle )
                        {
                            this.location.go('pg/channel/' + this.channelId + '/todo/tag/' + tagHandle);
                        }
                        else if ( filterHandle )
                        {
                            this.location.go('pg/channel/' + this.channelId + '/todo/filter/' + filterHandle);
                        }
                        else
                        {
                            this.location.go('pg/channel/' + this.channelId + '/todo/all');
                        }
                    }
                    else
                    {
