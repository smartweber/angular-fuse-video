import { Directive, ElementRef, Input, ComponentFactoryResolver, ViewContainerRef, TemplateRef, HostListener } from "@angular/core";
import { EventEmitter, Output, OnInit, OnChanges, SimpleChanges, AfterContentChecked, ChangeDetectorRef } from "@angular/core";
...
export class MentionDirective implements OnInit, OnChanges, AfterContentChecked {
  @HostListener('input', ['$event.target'])
  onInput(textArea: HTMLTextAreaElement): void {
    this.inputValue.emit(textArea.value);
    this.adjust();
  }
